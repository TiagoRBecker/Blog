   ...
   const { "blogCookie":token} = parseCookies()
    ...
    return (
      <Menu as="div" className="relative inline-block text-left">
        ...
        <div>
          <Menu.Button className="  inline-flex w-40 justify-start rounded-md   bg-opacity-95 px-4 py-2 my-1 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none ">
            {nameDrop}
